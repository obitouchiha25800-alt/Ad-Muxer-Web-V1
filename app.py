...
def start_mux():
    ...
    # --- DEFAULT FONT LOGIC ---
    # Agar user ne koi font select nahi kiya, toh 'default.ttf' dhoondo
    ...
    cmd = ['ffmpeg', '-y', '-headers', f'Referer: {url}', '-tls_verify', '0', '-reconnect', '1', '-reconnect_streamed', '1', '-i', url, '-i', sub_path]
    cmd.extend(font_arg)
